...
class Counts():
    ...
    def __init__(self):
        ...
        self.area_list.append(Area(
            area_id='15', xmin=134.16, ymin=113.23, xmax=161.35, ymax=134.31, z=0,
            coord_list=[
                (149.66, 121.91), (154.89,117.01), (151.37,113.23), (144.61,119.4), (138.78,124.83), (134.16,129.08),
                (137.47,132.64), (147.99,123.33), (149.16,124.48), (147.97,125.57), (149.44, 127.06), (146.15, 130.2),
                (150.5, 134.31), (153.68, 131.35), (161.35, 124.55), (155.82, 118.53), (150.69, 123.03), (149.66, 121.91)
            ])
        )
