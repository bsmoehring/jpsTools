...
inputPath = 'D:/Wichtiges/TUBerlin/Masterarbeit/Data/BerlinScenario/'                 
inputFile = inputPath + 'bvg.run189.10pct.100.plans.selected.xml'

filename, break_into, break_after = inputFile, 'person', 50000
